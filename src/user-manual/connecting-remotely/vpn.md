...
1. Once you have successfully enabled a VPN server on your router, follow instructions below to privately connect your client devices to your server using a VPN.

...
- **Alby Hub embedded light node**: This option tells Alby Hub to use its own, built-in LDK _light node_. This option is convenient but offers less control over your node.

...
**Contents**
  - [Nostr RS Relay](https://github.com/Start9Labs/nextcloud-startos/blob/update/040/docs/instructions.md) – Run your own relay
  - [noStrudel](https://github.com/Start9Labs/nextcloud-startos/blob/update/040/docs/instructions.md) – Host your own client
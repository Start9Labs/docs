...
**Contents**
- [Nexcloud Device Setup](https://github.com/Start9Labs/nextcloud-startos/blob/update/040/docs/instructions.md) - Set up your client device to connect to Nextcloud
- [Nextcloud Apps & Integrations](https://github.com/Start9Labs/nextcloud-startos/blob/update/040/docs/nextcloud-apps/) - Setup and use Nextcloud and 3rd party apps
